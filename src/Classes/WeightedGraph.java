...
public class WeightedGraph<Vertex> implements GraphInterface<Vertex> {
    ...
    public void addEdge(Vertex s, Vertex d) {
        throw new UnsupportedOperationException("addEdge(classes.Classes.Vertex, classes.Classes.Vertex) not " +
                "supported for weighted graph." +
                " Use addEdge(classes.Classes.Vertex, classes.Classes.Vertex, Double).");
